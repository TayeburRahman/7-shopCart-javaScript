...
const showProducts = (products) => {
  ...
  for (const product of allProducts) {
    ...
    <img class="product-image" src=${image}></img>
      ...
      <h3> ${product.title}</h3>
      <p class="text-warning">Category: ${product.category}</p>
      <h2>Price: $ ${product.price}</h2>
      <h5 class="text-info pb-3">Rate: <span class="text-danger">${product.rating.rate}</span> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Count: <span class="text-danger">${product.rating.count}</span></h5>
...
// update Total Added-Products count
let count = 0;
